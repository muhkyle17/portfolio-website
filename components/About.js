        ...
        <div className='container mx-auto flex flex-wrap lg:flex-nowrap h-full gap-10'>
          ...
          <div className='w-full flex flex-col gap-5 md:px-12 lg:px-0 text-lg'>
            ...
            <div className='flex gap-4'>
              ...
              <div className='py-3 px-7 w-fit font-medium text-white flex items-center justify-center rounded-xl hover:bg-primaryDarker bg-primary cursor-pointer hover:bg-secondary-hover md:btn-lg transition-all'>
